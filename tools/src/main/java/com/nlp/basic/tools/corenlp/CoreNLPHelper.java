...
public class CoreNLPHelper {
     ...
     * @date 2017年6月24日
     */
    static CoreNLPHelper getInstance() {
        return instance;
    }
     ...
     * @date 2017年6月24日
     */
    ArrayList<String> segment(String text) {
        return actions(text, TextAnnotation.class);
    }
     ...
     * @date 2017年6月24日
     */
    ArrayList<String> namedEntity(String text) {
        return actions(text, NamedEntityTagAnnotation.class);
    }
    ...
    public ArrayList<String> pos(String text) {
        return actions(text, PartOfSpeechAnnotation.class);
    }
